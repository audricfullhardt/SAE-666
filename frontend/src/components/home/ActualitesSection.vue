    ...
    <div class="mx-auto max-w-5xl">
      ...
      <div class="md:hidden">
        <div class="flex items-center gap-2">
          <button @click="prev" aria-label="Article précédent" class="flex-shrink-0 rounded-full bg-gray-100 p-2 transition hover:bg-gray-200 active:scale-95">
          ...
          <button @click="next" aria-label="Article suivant" class="flex-shrink-0 rounded-full bg-gray-100 p-2 transition hover:bg-gray-200 active:scale-95">
